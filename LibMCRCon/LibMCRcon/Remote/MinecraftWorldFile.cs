    ...
    public class MinecraftWorldFile : MinecraftFile
    {
        ...
        public void CreateMapFile(string localpath)
        {
            ...
            if (Regions.Count > 0)
            {
                ...
                var v = new Voxel(int.MaxValue, BlocksPerWorld) { Y = 0 };
                var p = new Voxel(int.MaxValue, PixelsPerRegion) { Y = 0 }; ;
        ...
        public void CreateMapFile(string localpath, int RegionsPerWorld)
        {
            ...
            if (Regions.Count > 0)
            {
                ...
                topo = new Bitmap(this.PixelsPerRegion, this.PixelsPerRegion);
                tile = new Bitmap(this.PixelsPerRegion, this.PixelsPerRegion);
                ...
                gTopo.FillRectangle(SolidBrush, 0, 0, this.PixelsPerRegion, this.PixelsPerRegion);
                gTile.FillRectangle(SolidBrush, 0, 0, this.PixelsPerRegion, this.PixelsPerRegion);
        ...
        public void CreateMapFile(MinecraftTransfer UP,  string localpath)
        {
            ...
            if (Regions.Count > 0)
            {
                ...
                topo = MinecraftFileCentered.RetrieveBitmap(UP, FileName(MineCraftRegionFileKind.TOPO)) ?? new Bitmap(PixelsPerRegion, PixelsPerRegion);
                tile = MinecraftFileCentered.RetrieveBitmap(UP, FileName(MineCraftRegionFileKind.TILE)) ?? new Bitmap(PixelsPerRegion, PixelsPerRegion);
